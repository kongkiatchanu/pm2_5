...
<?php 
	...
	$time_color = 'ffc000';
	$image_bg = site_url().'template/image/report/report_bg_dev4.png?v=1';
			...
			<div id="imagesave" style="width:1024px;margin:0 auto;position: relative;">
				...
				<?php 
								...
								foreach($ar_marker as $k=>$item){
									...
									<div class="ab a<?=$k?>_h">
										<div class="box">
											<img src="/template/image/report/realtime_<?=color_dev_type($pm25)?>.png" width="80">
											<div class="ab hourly font_text" style="color:#<?=color_dev_type($pm25)!=3?'fff':'333'?>"><?=$pm25?></div>
										</div>
									</div>
									<div class="ab a<?=$k?>_d">
										<div class="box">
											<img src="/template/image/report/24hr_<?=color_dev_type($daily_pm25)?>.png" width="80">
											<div class="ab daily font_text" style="color:#<?=color_dev_type($daily_pm25)!=3?'fff':'666'?>"><?=$daily_pm25?></div>
										</div>
									</div>
									<?php
								}
