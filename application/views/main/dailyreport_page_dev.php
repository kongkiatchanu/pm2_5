...
<?php 
	...
	$time_color = $this->uri->segment(2)<13? '2e75b6':'ffc000';
	$image_bg = site_url().'template/image/report/report_bg.png?v=1';
	$image_bg = $this->uri->segment(2)<13? site_url().'template/image/report/2023_bg_7_v3.png?v=17':site_url().'template/image/report/2023_bg_4_v3.png?v=17';
