...
$sql = "UPDATE member SET member_status = '".mysqli_escape_string($mysqli,$_POST["is_show"])."'
...
?>
	...
	<div class="btn-group">
		...
		<ul class="dropdown-menu" role="menu">
			<li>
				<a href="#<?=$_POST["id"]?>" class="member_status_on">อนุมัติการใช้งาน</a>
			</li>
			<li>
				<a href="#<?=$_POST["id"]?>" class="member_status_off">ระงับการใช้งาน</a>
			</li>
